...
public class MediaMuxerWrapper {
    ...
    private static final SimpleDateFormat mDateTimeFormat = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss", Locale.FRANCE);
	...
	public MediaMuxerWrapper(String ext) throws IOException {
		...
		try {
			...
			mOutputPath = getCaptureFile(Environment.getExternalStorageDirectory()+"/newspecapprepository", ext).toString();
...
//**********************************************************************
	 ...
	 */
	/*package*/ @TargetApi(Build.VERSION_CODES.LOLLIPOP)
...
//**********************************************************************
    ...
    public static final File getCaptureFile(final String type, final String ext) {
		...
		final File dir = new File(Environment.getExternalStorageDirectory()+"/newspecapprepository", DIR_NAME);
